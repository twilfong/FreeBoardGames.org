/*
 * Copyright 2020 The @freeboardgame.org/boardgame.io Authors.
 *
 ...
 * BGBoard
 *
 * Component that will show a configurable backgammon board. The vertical
 * columns of squares are labeled with letters from a to z, while the rows are
 * labeled with numbers, starting with 1.
 *
 * Props:
...
export class BGBoard extends React.Component<any, any> {
  static defaultProps = {
    invert: false,
    primaryColor: '#ffce9e',
  ...
  render() {
    ...
    // Build colorMap with bgboard pattern.
